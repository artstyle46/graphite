...
def setup_app():
    ...
    api.add_resource(Register, '/signup', strict_slashes=False)
    api.add_resource(VendorRegister, '/vendor', strict_slashes=False)
    api.add_resource(UpdatePassword, '/update', strict_slashes=False)
    api.add_resource(Upload, '/upload/image', strict_slashes=False)
    api.add_resource(CreateOrder, '/order/create', strict_slashes=False)
    api.add_resource(Payment, '/order/payment', strict_slashes=False)
    api.add_resource(CancelOrder, '/order/cancel', strict_slashes=False)
    api.add_resource(ShowOrders, '/order/show', strict_slashes=False)
    api.add_resource(ShowOrders, '/order/show/id', strict_slashes=False)